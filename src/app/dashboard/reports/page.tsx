  ...
  return (
    <div className="space-y-8 print:p-0">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 print:hidden">
        <div className="bg-pink-400 border-[4px] border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] w-full md:w-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="neo-card bg-blue-100">
          <p className="font-bold text-slate-500 uppercase text-xs tracking-widest">
            Total Penjualan ({period === "all" ? "Semua" : period === "daily" ? "Hari Ini" : period === "weekly" ? "Minggu Ini" : "Bulan Ini"})
          </p>
        ...
        <div className="neo-card bg-green-100">
          <p className="font-bold text-slate-500 uppercase text-xs tracking-widest">
            Total Transaksi ({period === "all" ? "Semua" : period === "daily" ? "Hari Ini" : period === "weekly" ? "Minggu Ini" : "Bulan Ini"})
          </p>
